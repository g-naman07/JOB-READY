    ...
    return (
        <div className="landing-page">
            <nav className="navbar glass-panel">
                <div className="logo">
                    <span className="text-gradient">RoleReady</span>
                </div>
            ...
            <footer className="landing-footer">
                <div className="footer-content">
                    <div className="footer-brand">
                        <span className="text-gradient logo-small">RoleReady</span>
                ...
                <div className="footer-bottom">
                    <p>&copy; {new Date().getFullYear()} RoleReady. All rights reserved.</p>
                </div>
            </footer>
        </div>
    );
