...
git clone https://github.com/g-naman07/RoleReady.git
cd RoleReady
...
```json
// Request Body
{ "username": "g-naman", "email": "nam@example.com", "password": "secret123" }

// Response 201
{ "message": "User registered successfully", "user": { "id": "...", "username": "g-naman", "email": "nam@example.com" } }
```

#### POST `/api/auth/login`
```json
// Request Body
{ "email": "name@provider.com", "password": "hi123" }

// Response 200
{ "message": "User loggedIn successfully.", "user": { "id": "...", "username": "g-naman", "email": "nam@example.com" } }
```
